        ...
        <>
          <div className="space-y-3">
            {items.map((item) => {
              ...
              if (href) {
                return (
                  <Link
                    key={item.id}
                    href={href}
                    className="flex items-center justify-between rounded-3xl border border-[#EBEBEB] bg-white p-4 transition-colors hover:border-[#FFD3C8] hover:bg-[#FFF9F6]"
              ...
              return (
                <div key={item.id} className="flex items-center justify-between rounded-3xl border border-[#EBEBEB] bg-white p-4">
                  {body}
                </div>
              )
            })}
          ...
          <div className="mt-5 flex flex-col gap-3 rounded-3xl border border-[#EBEBEB] bg-white px-4 py-3 sm:flex-row sm:items-center sm:justify-between">
