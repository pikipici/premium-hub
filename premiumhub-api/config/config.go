...
type Config struct {
	...
	// Low inventory worker (Round 5)
	GmailLowInvCheckMinutes  int
	GmailLowInvCooldownHours int
...
func Load() *Config {
	...
	return &Config{
		...
		GmailLowInvCheckMinutes:         ei("GMAIL_LOW_INV_CHECK_MINUTES", 30),
		GmailLowInvCooldownHours:        ei("GMAIL_LOW_INV_COOLDOWN_HOURS", 6),
